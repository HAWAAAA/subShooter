...
public class MenuState extends State
{
	...
	public void render(SpriteBatch sb) 
	{
		...
		if (Gdx.input.getX() < optionsX + OPTIONS_WIDTH && Gdx.input.getX() > optionsX &&  SubStrike.HEIGHT - Gdx.input.getY() < 405 + OPTIONS_WIDTH && SubStrike.HEIGHT - Gdx.input.getAccelerometerY() > 405)
		{
